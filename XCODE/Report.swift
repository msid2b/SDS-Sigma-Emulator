...
class InstructionTimingReport: PDFReport {
    ...
    override func main() {
        ...
        printHeading("INSTRUCTION TIMING AND EXECUTION STATISTICS")
        printLine("Instruction Count: \(cpu.instructionCount)")
        ...
        if let m = machine.realMemory {
            ...
            printLine("       Page  Address           0/8           1/9           2/A           3/B           4/C           5/D           6/E           7/F")
